		...
		public partial class Meta 
		{
			...
			public partial class Fields
			{
				...
				public static bool TryGet(string memberName, out string logicalName)
				{
					switch (memberName)
					{
						case nameof(Body): logicalName = Body; return true;
						case nameof(FileName): logicalName = FileName; return true;
						case nameof(FileSize): logicalName = FileSize; return true;
						case nameof(MimeType): logicalName = MimeType; return true;
						case nameof(Msft_DataState): logicalName = Msft_DataState; return true;
						case nameof(Prefix): logicalName = Prefix; return true;
						case nameof(Subject): logicalName = Subject; return true;
						case nameof(VersionNumber): logicalName = VersionNumber; return true;
						default: logicalName = null; return false;
					}
				}
				public static IEnumerable<string> GetAll() => 
					new string[] {Body,FileName,FileSize,MimeType,Msft_DataState,Prefix,Subject,VersionNumber,};
		...
		public partial class Meta 
		{
			...
			public partial class Fields
			{
				...
				public static bool TryGet(string memberName, out string logicalName)
				{
					switch (memberName)
					{
						case nameof(Address1_Line1): logicalName = Address1_Line1; return true;
				...
				public static IEnumerable<string> GetAll() => 
					new string[] {Address1_Line1,FirstName,LastName,};
