...
using VerifyProxyCS = CSharpCodeFixVerifier<ProxyTypesAssemblyAnalyzer, XrmToolsAnalyzersCodeFixProvider>;
...
";
    ...
    [Fact]
    public async Task XrmTools010_AddProxyTypesAssemblyAttribute_BasicCase()
    {
        var before = Preamble + @"
...
";
        ...
        var test = new VerifyProxyCS.Test
        {
            TestCode = before,
            ...
            FixedState =
            {
                Sources =
                {
                    ("/0/Test0.cs", beforeNoMarkup),
                    ("ProxyTypesAssemblyInfo.cs", @"// <auto-generated />
[assembly: global::Microsoft.Xrm.Sdk.Client.ProxyTypesAssemblyAttribute]
"),
                }
            },
            BatchFixedState =
...
"),
    ...
    [Fact]
    public async Task XrmTools010_AddProxyTypesAssemblyAttribute_MultipleEntityTypes()
    {
        var before = Preamble + @"
public sealed class {|#0:Account|} : Microsoft.Xrm.Sdk.Entity
{
...
public sealed class Contact : Microsoft.Xrm.Sdk.Entity
{
}
";
...
"),
    ...
    [Fact]
    public async Task XrmTools010_AddProxyTypesAssemblyAttribute_WithExistingAttributes()
    {
        var before = @"
...
"),
    ...
    [Fact]
    public async Task XrmTools010_AddProxyTypesAssemblyAttribute_InheritedEntityType()
    {
        var before = Preamble + @"
public abstract class BaseEntity : Microsoft.Xrm.Sdk.Entity
{
}

public sealed class {|#0:Account|} : BaseEntity
{
}
";
