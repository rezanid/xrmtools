...
[Command(PackageGuids.XrmToolsCmdSetIdString, PackageIds.NewPluginCmdId)]
internal sealed class NewPluginFileCommand : BaseDICommand
{
    private readonly ILogger<NewPluginFileCommand> logger;
    private readonly IAssemblySelector assemblySelector;

    public NewPluginFileCommand(
        DIToolkitPackage parentPackage, 
        ILogger<NewPluginFileCommand> logger, 
